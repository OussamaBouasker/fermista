 ...
 */
final class Version20250215171826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE consultation (id INT AUTO_INCREMENT NOT NULL, rapportmedical_id INT DEFAULT NULL, date DATE DEFAULT NULL, heure TIME DEFAULT NULL, lieu VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_964685A617D4704B (rapportmedical_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
